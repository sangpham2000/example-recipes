import Matching2Processor from "../../../processors/matching2.processor.js";
import BaseProcessor from "../../../processors/base.processor.js";
import { data2 } from "../data/igs_lcms_li_bank_matching2.js";

describe("Matching2 Worker 2", () => {
  before(async () => {
  ...
  it("should process all question items", async function () {
    ...
    const questionWorker = new Matching2Processor(questionIds);
    ...
    console.log("🎉 Matching2 worker processed successfully!");
  });
