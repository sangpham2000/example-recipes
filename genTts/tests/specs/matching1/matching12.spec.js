...
import { data2 } from "../data/igs_lcms_li_bank_matching1.js";

describe("Matching1 Worker 2", () => {
  before(async () => {
  ...
  it("should process all question items", async function () {
    ...
    const questionWorker = new Matching1Processor(questionIds);
    ...
    console.log("🎉 Matching1 worker processed successfully!");
  });
