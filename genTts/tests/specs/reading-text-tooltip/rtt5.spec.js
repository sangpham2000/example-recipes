...
import { data5 } from "../data/igs_lcms_li_bank_reading_text_tooltip.js";

describe("RTT Worker5", () => {
  before(async () => {
  ...
  it("should process all question items", async function () {
    ...
    console.log("🎉 RTT worker5 completed successfully!");
  });
